...
<div id="recommendation" class="gt-tab-pane">
	<p class="about-description">
		<?php esc_html_e( 'The best resources for WordPress websites, handpicked and recommended by GretaThemes.', 'justread' ); ?>
	</p>
		...
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					<h3>WPForms</h3>
					<p><?php esc_html_e( 'The most beginner friendly WordPress contact form plugin with drag & drop form builder.', 'justread' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
				<a class="button" target="_blank" href="https://gretathemes.com/recommends/wpforms/"><?php esc_html_e( 'Get It Now', 'justread' ); ?></a>
			</div>
		</div>
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					<h3>ShortPixel</h3>
					<p><?php esc_html_e( 'Compress & optimize images with no difference in quality. Resulted smaller images and faster website.', 'justread' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
				<a class="button" target="_blank" href="https://gretathemes.com/recommends/shortpixel/"><?php esc_html_e( 'Get It Now', 'justread' ); ?></a>
			</div>
		</div>
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					<h3>WP Rocket</h3>
					<p><?php esc_html_e( 'The most powerful caching plugin that make your WordPress websites load fast really fast.', 'justread' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
				<a class="button" target="_blank" href="https://gretathemes.com/recommends/wp-rocket/"><?php esc_html_e( 'Get It Now', 'justread' ); ?></a>
			</div>
		</div>
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					<h3>WPML</h3>
					<p><?php esc_html_e( 'The best WordPress multilingual plugin that can translate everything. Compatible with our themes.', 'justread' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
				<a class="button" target="_blank" href="https://gretathemes.com/recommends/wpml/"><?php esc_html_e( 'Get It Now', 'justread' ); ?></a>
			</div>
		</div>
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					<h3>WP Engine</h3>
					<p><?php esc_html_e( 'The perfect managed WordPress hosting that has great support, fast loading times and secure servers.', 'justread' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
				<a class="button" target="_blank" href="https://gretathemes.com/recommends/wpengine/"><?php esc_html_e( 'Get It Now', 'justread' ); ?></a>
			</div>
		</div>
		<div class="extension">
			<div class="extension-inner">
				...
				<div class="extension-info">
					<h3>Hawk Host</h3>
					<p><?php esc_html_e( 'A fast, reliable and SSD-powered WordPress hosting with affordable price for small websites.', 'justread' ); ?></p>
				</div>
			</div>
			<div class="extension-action">
				<a class="button" target="_blank" href="https://gretathemes.com/recommends/hawk-host/"><?php esc_html_e( 'Get It Now', 'justread' ); ?></a>
			</div>
		</div>
	</div>
</div>
