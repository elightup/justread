...
?>
<h3 class="more-themes"><?php esc_html_e( 'More themes from us', 'justread' ); ?></h3>
	...
	<?php foreach ( $themes as $slug => $theme ) : ?>
		...
		<div class="recommended-theme">
			...
			<div class="entry-header">
				...
				<a href="<?php echo esc_url( $demo_url ); ?>"><?php echo esc_html__( 'Live Demo', 'justread' ); ?></a>
			</div>
		</div>
	<?php endforeach; ?>
</div>
...
<p class="more-themes-btn">
	<a href="<?php echo esc_url( "https://gretathemes.com/wordpress-themes/{$this->utm}" ); ?>" target="_blank" class="button button-primary">
		...
		esc_html_e( 'Browser All Themes', 'justread' );
		?>
	</a>
</p>
