...
<div id="support" class="gt-tab-pane">
	<div class="feature-section two-col">
		<div class="col">
			<h3><?php esc_html_e( 'Contact Support', 'justread' ); ?></h3>
			<p><?php esc_html_e( 'Still need help with Justread? We offer excellent support for you. Open up a ticket and we will get back to you as soon as possible.', 'justread' ); ?></p>
		...
		<div class="col">
			<h3><?php esc_html_e( 'More Themes From Us', 'justread' ); ?></h3>
			<p>
				<?php
					// Translators: theme name.
					echo esc_html( sprintf( __( 'If you like %s, you might want to see another beautiful themes from ', 'justread' ),  $this->theme->name ) );
				?>
				...
				<?php echo esc_html__( ' We build high quality Wordpress Themes that are well designed and simple to set up. Check them out here!', 'justread' )  ?>
			</p>
			<a class="button button-primary" href="<?php echo esc_url( 'https://gretathemes.com/wordpress-themes/' ) ?>">Visit GretaThemes</a>
		</div>
	</div>
	<h2><?php esc_html_e( 'You Might Also Like', 'justread' ) ?></h2>
		...
		<div class="col product">
			...
			<div class="product__body">
				...
				<?php
					...
					printf( esc_html__( 'Modern, clean, responsive %s for all your needs. Fast loading, easy to use and optimized for SEO.', 'justread' ), '<strong>premium WordPress themes</strong>' )
				?>
			</div>
		</div>
		<div class="col product">
			...
			<div class="product__body">
				...
				<?php
					/* translators: placeholder for HTML */
					printf( esc_html__( 'The lightweight %1$s feature-rich WordPress plugin that helps developers to save time building %2$s.', 'justread' ), '&amp;', '<strong>custom meta boxes and custom fields</strong>' )
				?>
			</div>
		</div>
		<div class="col product">
			...
			<div class="product__body">
				...
				<?php
					/* translators: placeholder for HTML */
					printf( esc_html__( 'Professional %s that help you empower your e-commerce sites and grow your business.', 'justread' ), '<strong>WordPress plugins for WooCommerce</strong>' )
				?>
			</div>
		</div>
	</div>
